<h2 class="text-2xl font-bold mb-4">Adicionar Nova Despesa</h2>
<p class="mb-6 text-gray-600">Preencha os detalhes da despesa abaixo.</p>

<div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
    <form action="<?php echo BASE_URL; ?>/financeiro/salvarDespesa" method="POST">
        <!-- Campo Descrição -->
        <div class="mb-4">
        ...
        <!-- Campo Data -->
        <div class="mb-6">
            <label for="data" class="block text-gray-700 text-sm font-bold mb-2">Data de Vencimento:</label>

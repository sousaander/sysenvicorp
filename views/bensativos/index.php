...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
        <h3 class="text-lg font-semibold mb-4 border-b pb-2 flex justify-between items-center">
            ...
            <a href="<?php echo BASE_URL; ?>/bensAtivos/cadastro" class="text-sm font-medium text-sky-600 hover:text-sky-800">
                + Novo Ativo
            </a>
        </h3>
                    ...
                    <?php foreach ($maintenanceList as $asset): ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                <a href="<?php echo BASE_URL; ?>/bensAtivos/detalhe?id=<?php echo $asset['id']; ?>" class="text-sky-600 hover:text-sky-800 font-medium">
                                    <?php echo $asset['nome']; ?>
                                </a>
                            </td>

<div class="flex justify-between items-start mb-6">
    <div>
        ...
        <p class="text-gray-600">Selecione o funcionário e informe o período para calcular os valores de férias.</p>
    </div>
...
<div class="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto">
    <form action="<?php echo BASE_URL; ?>/rh/processarCalculoFerias" method="POST">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-3">
                ...
                <select id="funcionario_id" name="funcionario_id" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-sky-500 focus:ring-sky-500 p-2">
                    ...
                    <?php foreach ($funcionarios as $funcionario) : ?>
                        <option value="<?php echo $funcionario['id']; ?>"><?php echo htmlspecialchars($funcionario['nome']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="date" id="data_inicio" name="data_inicio" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-sky-500 focus:ring-sky-500 p-2">
            </div>
            ...
            <div>
                ...
                <input type="number" id="dias_ferias" name="dias_ferias" min="1" max="30" value="30" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-sky-500 focus:ring-sky-500 p-2">
            </div>
        </div>

        <div class="mt-8 pt-4 border-t border-gray-200 flex justify-end">
            <button type="submit" class="px-6 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 transition">Calcular Férias</button>
        </div>
    </form>
</div>
...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Remove estilos de layout da web e expande o container */
            .print-container {
                margin: 0;
                padding: 0;
                box-shadow: none;
...
<body class="bg-gray-100">
    <div class="print-container max-w-6xl mx-auto my-8 bg-white p-8 shadow-lg">
        <!-- Cabeçalho -->
        <div class="flex justify-between items-start border-b-2 pb-4 mb-4">
            ...
            <div class="text-right">
                <h2 class="text-xl font-semibold text-gray-700">Espelho da Folha de Pagamento</h2>
        ...
        <div class="no-print flex items-center gap-3 mb-6">
            <a href="<?php echo BASE_URL; ?>/rh/verFolha/<?php echo $mes; ?>/<?php echo $ano; ?>" class="bg-gray-500 text-white px-4 py-2 rounded-md shadow-sm hover:bg-gray-600">
                &larr; Voltar
            </a>

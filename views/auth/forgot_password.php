...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Recuperar Senha'; ?></title>
...
<body class="flex items-center justify-center h-screen relative bg-gray-100">
    ...
    <div class="w-full max-w-md relative z-10">
        <form action="<?php echo BASE_URL; ?>/auth/processForgotPassword" method="POST" class="bg-white shadow-lg rounded-xl px-8 pt-6 pb-8 mb-4">
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-600">Informe seu e-mail para receber instruções</p>
            </div>
            ...
            <p class="text-center text-sm text-gray-600">Lembrou a senha? <a href="<?php echo BASE_URL; ?>/auth/login" class="font-bold text-blue-500 hover:text-blue-800">Voltar ao Login</a>.</p>
        </form>

...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="w-full max-w-md">
        <form action="<?php echo BASE_URL; ?>/auth/processLogin" method="POST" class="bg-white shadow-lg rounded-xl px-8 pt-6 pb-8 mb-4">
            ...
            <p class="text-center text-sm text-gray-600">Não tem uma conta? <a href="<?php echo BASE_URL; ?>/auth/register" class="font-bold text-blue-500 hover:text-blue-800">Cadastre-se</a>.</p>
        </form>

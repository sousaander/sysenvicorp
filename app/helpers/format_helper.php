...
if (!function_exists('valorPorExtenso')) {
     ...
     * Esta função não depende da extensão 'intl' e é compatível com a maioria dos ambientes PHP.
     *
     * @param float $valor O valor a ser convertido.
    ...
    function valorPorExtenso(float $valor): string
    {
        ...
        return trim($rt) ? ucfirst(trim($rt)) : "zero";
    }
}
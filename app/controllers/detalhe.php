...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1 bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mt-6 pt-6 border-t flex gap-2">
            <a href="<?php echo BASE_URL; ?>/clientes/editar/<?php echo $cliente['id']; ?>" class="w-full text-center bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 font-medium">
                Editar Cliente
            </a>
                    ...
                    <?php foreach ($interacoes as $interacao) : ?>
                        <li>
                            <div class="relative pb-8">
                                <?php if (!$loop->last) : // Adiciona a linha vertical para todos, exceto o último 
                                ?>

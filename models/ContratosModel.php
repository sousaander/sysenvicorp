...
class ContratosModel extends Model
{
        ...
        try {
            if ($id) {
                ...
                $sql = "UPDATE contratos SET 
                            titulo = :titulo, numero_contrato = :numero_contrato, numero_contrato_cliente = :numero_contrato_cliente, base_referencia = :base_referencia,
                            ...
                            cliente_id = :cliente_id, pessoa_id = :pessoa_id, projeto_id = :projeto_id, 
                ...
                $sql = "INSERT INTO contratos (
                            titulo, numero_contrato, numero_contrato_cliente, base_referencia, foro_eleicao, lei_aplicavel, resolucao_disputas, local_assinatura, cliente_id, pessoa_id, projeto_id, 
     ...
     * @param array|null $propostaData Dados da proposta (opcional, evita novo fetch)
     * @return bool
     */
    public function criarContratoDeProposta(int $propostaId, ?array $propostaData = null)
    {
        try {
            // 1. Busca os dados se não fornecidos
